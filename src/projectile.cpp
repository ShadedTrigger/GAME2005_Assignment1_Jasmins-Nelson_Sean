...
Projectile::Projectile() : m_maxSpeed(10.0f)
{
...
void Projectile::draw()
{
	...
	// draw the Projectile
	TextureManager::Instance().draw("projectile", x, y, getCurrentHeading(), 255, true);
...
void Projectile::setMaxSpeed(float newSpeed)
{
	m_maxSpeed = newSpeed;
}
